...
public final class ATrueLiteralPrimary extends PPrimary
{
    private TTrue _true_;

    public ATrueLiteralPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATrueLiteralPrimary(
    ...
    {
        ((Analysis) sw).caseATrueLiteralPrimary(this);
    }
