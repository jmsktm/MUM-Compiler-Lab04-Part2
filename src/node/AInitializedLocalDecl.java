...
public final class AInitializedLocalDecl extends PLocalDecl
{
    ...
    public Object clone()
    {
        return new AInitializedLocalDecl(
    ...
    {
        ((Analysis) sw).caseAInitializedLocalDecl(this);
    }
