...
public final class ANumericIntegerValue extends PIntegerValue
{
    private TIntegerLiteral _integerLiteral_;

    public ANumericIntegerValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumericIntegerValue(
    ...
    {
        ((Analysis) sw).caseANumericIntegerValue(this);
    }
