...
public final class AFalseLiteralPrimary extends PPrimary
{
    private TFalse _false_;

    public AFalseLiteralPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseLiteralPrimary(
    ...
    {
        ((Analysis) sw).caseAFalseLiteralPrimary(this);
    }
