...
public final class AMatchedGenericStmt extends PGenericStmt
{
    private PMatched _matched_;

    public AMatchedGenericStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMatchedGenericStmt(
    ...
    {
        ((Analysis) sw).caseAMatchedGenericStmt(this);
    }
