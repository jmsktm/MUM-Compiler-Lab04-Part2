...
class Type {
	...
	public Type(int t, int k, String arraySize) {
		...
		if (k != Type.arrayKind) {
			System.err.println(
					"The second argument must be an array kind in constructor for Type taking three arguments");
			k = Type.arrayKind;
		}
		kind_ = k;
		try {
	...
	public Type makeValueType() {
		...
		default:
			System.out.println("Illegal Type `" + type_ + "' in `Type::makeValueType'");
			System.exit(1);
			return null;
		}
	}
	...
	public Type makeVariableType() {
		...
		case unknownType:
			return Type.errorType;
		default:
			System.out.println("Illegal Type `" + type_ + "' in `Type::makeVariableType'");
			System.exit(1);
			return null;
		}
	}
	...
	public String toString() {
		...
		case unknownType:
			return ("error");
		default:
			System.out.println("Illegal Type `" + type_ + "' in `Type::toString'");
			System.exit(1);
			return null;
		}
	}
	...
	protected boolean isValidType(int t) {
		return (t == intType || t == boolType || t == charType || t == voidType || t == floatType || t == stringType
				|| t == unknownType);
	}
