...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTCharLiteral(@SuppressWarnings("unused") TCharLiteral node)
    {
        this.index = 1;
    }

    @Override
    public void caseTEscapeStringLiteral(@SuppressWarnings("unused") TEscapeStringLiteral node)
    {
        this.index = 2;
    }
